    ...
    <section className="event-info-all">
      ...
      <div className="event1">
        <Event1
          ...
          dURATION="TIMELINE"
          weeks="8 Weeks"
          propBackgroundImage="url('/event-img-14@2x.png')"
          propWidth="309px"
          propFlex="unset"
          propMinWidth="unset"
          propGap="240px"
        ...
        <div className="event-1">
          <img className="event-img-12" alt="" src="/event-img-15@2x.png" />
        ...
        <div className="leftarrowsvg-parent">
          ...
          <div className="reach-us">
            <div className="event-3">
              <img className="event-img-13" alt="" src="/event-img-16@2x.png" />
