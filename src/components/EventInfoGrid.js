      ...
      <div className="entrepreneurship-program-frame">
        ...
        <div className="heading-text">
          ...
          <Event1
            ...
            dURATION="DURATION"
            weeks="2 Weekends"
            propBackgroundImage="url('/event-img-11@2x.png')"
            propWidth="309px"
            propFlex="unset"
            propMinWidth="unset"
            propGap="213px"
          ...
          <div className="event-frame">
            ...
            <div className="t-i-m-e-l-i-n-e">
              <Event1
                ...
                dURATION="DURATION"
                weeks="3 Days"
                propBackgroundImage="url('/event-img-12@2x.png')"
                propWidth="unset"
                propFlex="1"
                propMinWidth="201px"
                propGap="213px"
