    ...
    <div className="timeline">
      ...
      <div className="event">
        ...
        <div className="div-fusion-image-element">
          ...
          />
          <Img1
            catelogImg1="/catelog-img-11@2x.png"
            ...
            propBackgroundImage="url('/catelog-img-11@2x.png')"
            propHeight="66px"
          />
          <Img1
            catelogImg1="/catelog-img-12@2x.png"
            ...
            propBackgroundImage="url('/catelog-img-12@2x.png')"
            propHeight="unset"
          />
          <Img
            catelogImg1="/catelog-img-13@2x.png"
          ...
          />
          <Img1
            catelogImg1="/catelog-img-14@2x.png"
            ...
            propPadding="var(--padding-194xl) var(--padding-xl) var(--padding-xl)"
            propBackgroundImage="url('/catelog-img-14@2x.png')"
            propHeight="unset"
          />
          <Img
            catelogImg1="/catelog-img-15@2x.png"
            ...
            propPadding="var(--padding-194xl) var(--padding-xl) var(--padding-xl)"
            propBackgroundImage="url('/catelog-img-15@2x.png')"
          />
        </div>
      </div>
